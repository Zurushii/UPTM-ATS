      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body space-y-4">
          ...
          <form class="space-y-4" @submit.prevent="handleSignIn">
            ...
            <div class="form-control">
              ...
              <label class="label">
                ...
                <NuxtLink to="/forget-password" class="label-text-alt link link-hover link-primary">
                  Forgot password?
                </NuxtLink>
              </label>
            </div>
            ...
            <!-- Error Message -->
            <div v-if="errorMessage" class="alert alert-error shadow-sm rounded-xl border border-error/20 bg-error/10 py-3">
          ...
          <p class="text-center text-sm opacity-70 mt-4">
            ...
            <NuxtLink to="/sign-up" class="link link-primary link-hover font-medium">
              Sign up
            </NuxtLink>
          </p>
        </div>
