...
const addSemesterToPlan = () => {
  const maxSem = creditPlans.value.reduce(
    (max, p) => Math.max(max, p.semester_number),
    0,
  );
  creditPlans.value.push({
...
<template>
  <div class="p-4 md:p-6 lg:p-8 w-full max-w-[1400px] mx-auto flex flex-col space-y-8 h-full relative">
    ...
    <div class="card bg-base-100 border border-base-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden relative group">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-xs text-base-content/50">
              Min/max credit hours per semester type
            </p>
          </div>
        </div>
        <button
      ...
      <div v-else class="p-4 space-y-4">
        <div class="grid grid-cols-2 gap-4">
          <!-- Long Semester -->
          <div
            class="p-3 bg-primary/5 rounded-lg border border-primary/20 space-y-3"
          >
            <div class="badge badge-primary badge-sm">Long Semester</div>
            <div class="grid grid-cols-2 gap-3">
              <div class="form-control">
                <label class="label py-0 pl-0"
                  ><span class="label-text text-xs">Min</span></label
                >
                <input
              ...
              <div class="form-control">
                <label class="label py-0 pl-0"
                  ><span class="label-text text-xs">Max</span></label
                >
                <input
          ...
          <!-- Short Semester -->
          <div
            class="p-3 bg-secondary/5 rounded-lg border border-secondary/20 space-y-3"
          >
        ...
        <div class="flex justify-end gap-2">
          <button class="btn btn-ghost btn-sm" @click="cancelEditCreditLimits">
            Cancel
          </button>
          <button
    ...
    >
      ...
      <div class="card-body p-0">
        ...
        >
          ...
          <p class="text-base-content/60 mt-4 animate-pulse">
        ...
        <template v-else-if="rules && rules.length > 0">
          <div class="flex flex-col">
            <div
              ...
              :class="
                collapsedIntakes.has(intakeType as string)
                  ? 'bg-base-200/30'
                  : 'bg-base-100'
              "
            >
                ...
                <div class="flex items-center gap-4">
                  ...
                  >
                    <svg
                      ...
                      :class="
                        collapsedIntakes.has(intakeType as string)
                          ? '-rotate-90 text-base-content/40'
                          : 'rotate-0'
                      "
                    >
                      <path
                  ...
                  <div>
                    ...
                    <div class="text-xs text-base-content/60">
                      {{ intakeRules.length }} rules configured
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                >
                  ...
                  <div class="col-span-12 md:col-span-3">
                    <div class="flex items-center gap-3">
                      <div
                        class="w-10 h-10 rounded-lg bg-base-200 flex items-center justify-center text-base-content/70 font-bold text-lg"
                      >
                        ≥
                      </div>
                      <div>
                        ...
                        <div
                          class="text-xs font-semibold uppercase tracking-wider text-base-content/50 mt-1"
                        >
                          Credits
                        </div>
                      </div>
                  ...
                  <div
                    class="col-span-1 hidden md:flex justify-center text-base-content/20 group-hover:text-primary/50 transition-colors"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                  ...
                  <div class="col-span-12 md:col-span-3">
                    <div class="flex items-center gap-2">
                      <div
                        class="badge badge-lg gap-2 h-auto py-2 px-3"
                        :class="
                          rule.entry_semester === 1
                            ? 'badge-primary'
                  ...
                  <!-- Actions -->
                  <div
                    class="col-span-12 md:col-span-5 flex items-center justify-between md:justify-end gap-3 mt-2 md:mt-0"
                  >
                    <!-- Plan Button -->
                    <button
                    ...
                    <!-- Divider -->
                    <div
                      class="h-6 w-px bg-base-content/10 hidden md:block"
                    ></div>

                    <!-- Admin Actions -->
                    <div class="join">
                      <button
                        class="btn btn-square btn-sm join-item btn-ghost text-base-content/70 hover:text-primary"
                      ...
                      <button
                        class="btn btn-square btn-sm join-item btn-ghost text-error"
      ...
      <!-- Info Footer -->
      <div
        class="bg-base-200/50 p-4 border-t border-base-200 text-sm flex gap-4"
      >
        ...
        <div class="text-base-content/70">
          <strong>Logic:</strong> During Intake Assessment, if a student's total
          transferred credits are greater than or equal to a rule's
          <strong>Credit Transfer</strong> value, they will be assigned the
          corresponding <strong>Entry Semester</strong>. The system checks rules
          from highest credit value to lowest.
        </div>
      </div>
    </div>
    ...
    <dialog
      ...
      :class="{ 'modal-open': isAddModalOpen }"
    >
      <div class="modal-box p-0 overflow-hidden">
        <div class="p-6 bg-primary text-primary-content">
          ...
          <p class="text-primary-content/70 text-sm">
            Create a new entry mapping for an intake type.
          </p>
        </div>
          ...
          <div class="grid grid-cols-2 gap-6">
            <div class="form-control hover:bg-transparent">
              ...
              <div class="relative">
                ...
                />
                <div
                  class="absolute left-4 top-3 text-base-content/40 font-bold"
                >
                  ≥
                </div>
              </div>
            ...
            <div class="form-control hover:bg-transparent">
              ...
              <div class="relative">
                ...
                />
                <div
                  class="absolute left-4 top-3 text-base-content/40 text-xs font-bold uppercase tracking-wider mt-0.5"
                >
                  Sem
                </div>
              </div>
    ...
    <dialog
      class="modal modal-bottom sm:modal-middle"
      :class="{ 'modal-open': isDeleteModalOpen }"
    >
      <div class="modal-box">
        <h3 class="font-bold text-lg text-error">Delete Rule?</h3>
        <p class="py-4 text-base-content/70">
          Are you sure you want to remove this rule? This will affect new
          student assessments.
        </p>
        ...
        <div v-if="deletingRule" class="alert alert-warning shadow-sm">
          ...
          <span class="text-sm">
            <strong>{{ deletingRule.intake_type }}</strong
            >: ≥ {{ deletingRule.credit_transfer }} credits → Sem
    ...
    <dialog
      class="modal modal-bottom sm:modal-middle"
      :class="{ 'modal-open': isDeleteIntakeModalOpen }"
    >
      <div class="modal-box">
        ...
        <p class="py-4">
          ...
          <strong
            >{{ rulesByIntakeType[deletingIntakeType!]?.length }} rules</strong
          >
          for
          <span class="font-bold badge badge-neutral">{{
            deletingIntakeType
          }}</span
          >. <br /><br />
      ...
      <div class="modal-box w-11/12 max-w-4xl p-0 h-[80vh] flex flex-col">
        ...
        >
          <div>
            ...
            <div
              v-if="creditPlanRule"
              class="text-sm mt-1 flex items-center gap-2 text-base-content/60"
            >
              <span class="badge badge-sm badge-ghost">{{
                creditPlanRule.intake_type
              }}</span>
              <span
                >Entry at
                <strong>Sem {{ creditPlanRule.entry_semester }}</strong> (≥
                {{ creditPlanRule.credit_transfer }} credits)</span
              >
            </div>
          </div>
        ...
        <div class="flex-1 overflow-y-auto p-6 bg-base-200/30">
          ...
          <div v-else class="space-y-4">
            <div
              v-for="(plan, index) in creditPlans"
              :key="index"
        ...
        >
          ...
          <button
            class="btn btn-primary"
            :disabled="isSubmitting || hasCreditPlanErrors"
      ...
      <div class="modal-box">
        ...
        >
          ...
          <div v-if="importFile" class="flex flex-col items-center gap-2">
            <div
              class="w-12 h-12 rounded-full bg-success/10 flex items-center justify-center text-success mb-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <div v-else class="flex flex-col items-center gap-2 py-4">
            <div
              class="w-12 h-12 rounded-full bg-base-200 flex items-center justify-center text-base-content/40 mb-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
